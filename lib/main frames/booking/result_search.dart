                        ...
                        showDialog(
                          ...
                          builder: (ctx) {
                            return CupertinoAlertDialog(
                              title: const Text('Planifier le voyage retour ?'),
                              actions: [
                                CupertinoDialogAction(
                                  child: const Text('Oui'),
                                  onPressed: () => Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (builder) => ResultSearchReturn(selectedDeparture: widget.selectedDeparture, selectedDestination: widget.selectedDestination))
                                  ),
                                ),
                                CupertinoDialogAction(
